...
#include "stdafx.h"
#include "spitoniccompressorsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitoniccompressorsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniccompressorsynthvoroguiwin32class"};				// the main window class name
